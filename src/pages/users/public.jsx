  ...
  return (
    <section>
      <div className="container img">
        <img
          className="userPublicProfileImage"
      ...
      <div className="container about">
        ...
        <p>
          ...
          tempora reprehenderit eum impedit dolorem dicta cum facere harum
          numquam!
        </p>
      </div>
      ...
      <div className="container">
        ...
        <div className="row scroll">
          <Site
            ...
            name="Dribbble"
            icon="logo-dribbble"
            theModal="dribbleModal"
          />
          <Site
            unique="#fiverrModal"
            name="Fiverr"
            icon="logo-fiverr"
            theModal="fiverrModal"
          />
          <Site
            unique="#pinterestModal"
            name="Pinterest"
            icon="logo-pinterest"
            theModal="pinterestModal"
          />
          <Site
            unique="#upworkModal"
            name="Upwork"
            icon="logo-upwork"
            theModal="upworkModal"
          />
        </div>
        ...
        <div className="row scroll">
          ...
          />
          <Site
            unique="#linkedInModal"
            name="LinkedIn"
            icon="logo-linkedin"
            color="powder-blue"
            theModal="linkedInModal"
            widget={<LinkedIn />}
          />
          <Site
            unique="#snapModal"
        ...
        <div className="row scroll">
          <Site
            ...
            name="Github"
            icon="logo-github"
            theModal="githubModal"
          />
          <Site
            unique="#gitlabModal"
            name="Gitlab"
            icon="logo-gitlab"
            theModal="gitlabModal"
          />
          <Site
            unique="#pastebinModal"
            name="pastebin"
            icon="logo-pastebin"
            theModal="pastebinModal"
          />
        </div>
        ...
        <div className="row scroll">
          <Site
            unique="#pluralSightModal"
            name="Plural Sight"
            icon="logo-pluralsight"
            theModal="pluralSightModal"
          />
          <Site
            unique="#udemyModal"
            name="Udemy"
